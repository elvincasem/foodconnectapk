...
<div class="wrapper" >
  ...
  <div class="content-wrapper" style="background-image: url('pizza.png'); background-size: cover; background-position: center;">
    ...
    <section class="content">
      ...
      <!-- Your Page Content Here -->
		...
		<span class="logo-lg"><center><img src="foodconnect.png" height="100px" width="100px"></center></span>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>Choose your type of restaurant:</label>
                <select class="form-control select2" style="width: 100%;" id="select_type" name="type">
			  ...
			  <div class="form-group">
                <label>Choose your municipality:</label>
                <select class="form-control select2" style="width: 100%;" id="select_municipality" name="municipality">
			  ...
			  <br>
			  <input type="submit" class="btn btn-block btn-sm btn-danger" value="Search">
