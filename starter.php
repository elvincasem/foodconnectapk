                ...
                <div class="carousel-inner">				  
				  <?php
					...
					$first = true;
						...
						$adlist = selectListSQL("SELECT * FROM tblad");			
						foreach ($adlist as $adrows => $adlink) {
							$advertisement = $adlink['advertisement'];
							
							if($first){
								echo "<div class='item active' style='height: 150px;'>
									  <img src='../github/foodconnect/assets/uploads/$advertisement'>
									  </div>";
								$first = false;
							}else{
	  ...
	  <div class="row" >
					...
					<?php
						include_once("functions.php");
							...
							$reslist = selectListSQL("SELECT * FROM tblrestaurant, tbltype WHERE tblrestaurant.rid = tbltype.rid AND type = '$type' AND municipality = '$municipality' ORDER BY restaurantname DESC");
								  ...
								  <div class='box box-widget collapsed-box'>
									<div class='box-header with-border'>
									  <div class='user-block'>
										...
										<span class='description'>$barangay, $municipality, La Union</span>
          ...
          <div class="box box-widget collapsed-box">
            <div class="box-header with-border">
              <div class="user-block">
				...
				<span class="pull-right badge bg-red" style="margin-top: 5px; margin-right: 5px;">Fast Food</span>
				<span class="pull-right badge bg-red" style="margin-top: 5px; margin-right: 5px;">Steak House</span>
				<span class="pull-right badge bg-red" style="margin-top: 5px; margin-right: 5px;">Coffee Shop</span>
              </div>
              <div class="box-tools">
		...
		<div class="col-md-6">
          <div class="box box-widget collapsed-box">
            <div class="box-header with-border">
              <div class="user-block">
                <img class="img-circle" src="dist/img/kfc.png" alt="User Image">
                <span class="username"><a href="profile.html">KFC</a></span>
                <span class="description">Marcos Highway, Plaza, City of San Fernando, La Union</span>
                <span class="description">
					<i class="fa fa-star" style="color: #FFC107;"></i>	
					<i class="fa fa-star" style="color: #FFC107;"></i>	
		...
		<div class="col-md-6">
          <div class="box box-widget collapsed-box">
            <div class="box-header with-border">
              <div class="user-block">
                <img class="img-circle" src="dist/img/chowking.jpg" alt="User Image">
                <span class="username"><a href="profile.html">Chowking</a></span>
                <span class="description">Marcos Highway, Plaza, City of San Fernando, La Union</span>
                <span class="description">
					<i class="fa fa-star" style="color: #FFC107;"></i>	
					<i class="fa fa-star"></i>	
				...
				echo "<div class='row'>
						<div class='col-lg-12'>
						  <div class='small-box bg-red'>
							<div class='inner' style='background: url(../github/foodconnect/assets/uploads/$advertisement) center center; background-size: cover; height: 150px;'>
							</div>
							
							<a href='profile.php?rid=".$rid."' class='small-box-footer'>
